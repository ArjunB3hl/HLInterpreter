// TESTHL CLASS USED TO TEST CPS710 ASSIGNMENT 5 WITH STATIC SCOPING
//
class TestHL {
    ...
    public static void main(String args[]) {
		...
		Scope.pushGlobal(); 
		// Initialize activation stack  with global scope
		HLActivation.pushScope(0); 
    ...
    private static boolean nextParse() {
        ...
        // System.out.println("parsing finished");
  		  // tree.dump("dump tree ");  // Uncomment to display  AST
